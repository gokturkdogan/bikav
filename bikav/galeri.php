...
$sorgu=$vt->prepare('SELECT *FROM fotografgalerisi');
$sorgu->execute();
$photos=$sorgu-> fetchAll(PDO::FETCH_OBJ);
?>
				...
				<div class="col-lg-4 col-md-6 text-center strawberry">
					<div class="single-product-item">
						<div class="product-image">
							<img src="<?= $photo->resim?>" alt="">
						</div>
						<h3><?= $photo->baslik?></h3>
						<p class="product-price"><span><?= $photo->aciklama?></span></p>
						<a href="galeri-detay.php?id=<?= $photo->ID ?>" class="cart-btn"><i class="fas fa-plus"></i>Fotoğraf Sayfası</a>
					</div>
				</div>	
                <?php } ?>
			</div>
